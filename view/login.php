            ...
            <form class="col-md-9 m-auto" method="post" role="form" action="../action.php">
                <div class="row">
                    <div class="form-group col-md-6 mb-3">
                        <label for="inputname">Email or User Name</label>
                        <input type="text" class="form-control mt-1" id="name" name="loginData" placeholder="Email or User name">
                    </div>

                    <div class="form-group col-md-6 mb-3">
                        <label for="inputname">Password</label>
                        <input type="password" class="form-control mt-1" id="name" name="passwordLogin" placeholder="Password">
                    </div>
